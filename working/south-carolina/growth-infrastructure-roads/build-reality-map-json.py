...
SCORECARDS = [
    ...
    ("Fixing and maintaining existing roads", "rarely_moved", "high",
     "First committee for every standalone bill; the money moved through budget provisos (86.1 yearly; $417.4M FY 2024-25, $200M FY 2025-26, $225M FY 2026-27; Road Buyback 84.18), and the pothole-reporting design passed inside Act 177 (Pothole Mitigation Program, 57-5-1800: seven-day repairs, $15M/yr)",
     ["126:H5363", "125:H4610", "126:H4687", "126:S831"]),
    ("Who runs SCDOT (governance and accountability)", "mixed", "medium-high",
     "Judiciary, unheard in 2019 and 2024 - then the same design passed near-unanimously in 2026 with Senate leadership carrying it (126:S831, Act 177), as an omnibus also carrying the pothole program, design-build authority, choice-lane toll rules, P3s, and a four-year audit",
     ["126:S831", "123:H3111", "125:H5045", "126:H5071"]),
    ("Road contracts and contractor accountability", "mixed", "medium",
     "Standalone bills died in committee and two regulation resolutions were stranded on the 2020 calendar - but the design-build method passed inside Act 177 (57-5-1710/57-5-1720), with P3s (max 60 years) and a four-year external audit; edges passed (123:S401 Act 36, 126:H3768 Act 244); transparency lives in provisos (84.8 priority lists, 84.15 dashboard)",
     ["125:H5312", "126:S831", "123:S1069", "123:S401", "126:H3768"]),
...
CARDS = [
    {"proposal_id": "local-funding-tools",
     "citizens_proposed": "New or expanded local funding tools: penny/sales taxes, impact fees, tolls, parking fees (High frequency: Columbia, Florence, Charleston; High consensus - broad agreement the state needs new sources of funding; tradeoff: people don't like being taxed without knowing where the money goes, so taxes should include greater transparency).",
     "lawmakers_tried": "Widening the existing referendum-gated pennies: transit eligibility filed all four sessions, penny stacking (124:H3129), 11-year reimposition (125:S116), grocery carve-outs; five I-95 toll bills; a local-option gas tax (123:S172). All died in first committee. Enacted: the County Green Space Sales Tax Act (124:S152, Act 166 of 2022, 43-1/41-3/67-28) - the one new local penny - plus flexibility acts (123:S217 Act 146, 124:S40 Act 89, 126:H4589 Act 203). On the impact-fee tool the proposal names: ten bills in both directions on the 1999 Development Impact Fee Act (expand: residential-only 125:H4659, resurfacing as fundable cost 126:H5088, gentrification fee 124:H3460/126:H4008; narrow: exclude maintenance/admin costs 125:H4981/S856/H5017, 126:H3165; exempt repeat buyers 126:H4672) - zero hearings either way.",
     "where_similar_stopped": "Senate Finance, House Ways and Means, Senate Transportation - no hearings, in both the penny/toll and impact-fee lanes. The one enacted impact-fee rule blocked the fees (FY 2021-22 proviso 117.96, schools, one year, not renewed). The toll framework itself was later rewritten inside Act 177 of 2026: usage charges only on new-capacity 'choice lanes', never on existing free lanes.",
     "adjacent_carriers": ["Sen. Davis", "Sen. Scott", "Sen. Hutto (tolls)", "Rep. Pendarvis", "Rep. Bailey (impact-fee narrowing)"],
     "levers_venue": "Transportation penny + tolls: Title 4 Ch. 37 (referendum). Capital project penny: Title 4 Ch. 10. Impact fees: Section 6-1-910 et seq. (legal since 1999, with strict conditions - capital improvements plan; no maintenance funding). Interstate tolls also need federal approval. Every local tax tool is referendum-gated - the transparency condition citizens attached is structurally present in ballot-question requirements.",
     "open_questions": ["New tool, or make the existing penny and impact-fee tools usable for the costs citizens named?", "Why does a preservation penny pass while transportation-penny expansions and impact-fee bills go unheard in the same committees?", "How does the group answer the school-proviso precedent - the one legislative action on impact fees blocked them?"]},
    {"proposal_id": "state-master-planning",
     "citizens_proposed": "State comprehensive/master planning vs. fragmented county plans; regional control (Very High frequency: all 4 conversations; Mixed consensus - efficiency gains from centralized planning vs. skepticism of removing local control; a consensus recommendation in Charleston; tradeoff: removing local control could let the state go against residents' wishes).",
    ...
    {"proposal_id": "fix-roads-first",
     "citizens_proposed": "Fix the roads we've got first (Medium frequency: Columbia and the online session; Mixed consensus - broad agreement maintenance must be factored in, but many want expanded infrastructure; tradeoff: expansion expense vs. maintaining what exists, with worry that too much goes to capital projects and not enough to maintenance).",
     "lawmakers_tried": "Pavement preservation program (126:H5363, 'Fix Our Roads Accountability Act'), SCDOT must maintain transferred roads (125:H4610), pothole hotlines (124:H3871, 125:H3451), sheriff road-hazard reports (126:H4687). All died in first committee - but the pothole-reporting design passed inside the SCDOT Modernization Act (126:S831, Act 177 of 2026): the Pothole Mitigation Program (57-5-1800), with public reporting, a seven-day repair rule, and $15M a year for repeat potholes.",
     "where_similar_stopped": "Standalone bills: first committee, every one. Money: moved through the budget - proviso 86.1 (yearly fix-it-first rule for CTC money), $417.4M FY 2024-25 (CTC $200M + bridges $100M + rural road safety $117.4M), $200M FY 2025-26 bridges, $225M FY 2026-27, Road Buyback Program (84.18, new FY 2026-27). Act 177 also reset the county 'C'-funds rule to a 33% state-highway share.",
    ...
    {"proposal_id": "no-new-taxes",
     "citizens_proposed": "No new taxes / oppose extra taxes and fees (Medium frequency: multiple tables at Columbia and Florence; Low consensus - sharp disagreement over whether new taxes are essential or the state should keep costs low; some argued low taxes are one reason infrastructure suffers).",
    ...
    {"proposal_id": "contractor-accountability",
     "citizens_proposed": "Improve the contractor bidding process / hold contractors accountable (Medium frequency: the online conversation and Greenville; High consensus - widely agreed a low-cost fix; participants felt the state was not getting quality contractors for road repairs and pushed for more standards and transparency in bidding).",
     ...
     "where_similar_stopped": "Committee or calendar for the standalone bills; no floor votes. The method then passed inside Act 177 of 2026 (126:S831): phased design-build (57-5-1710), CM/GC authority (57-5-1720), P3 agreements up to 60 years (57-3-205), and a four-year external performance audit. Edges passed: utility-relocation costs (123:S401, Act 36 of 2019, extended by 126:H3768, Act 244 of 2026) and contractor licensing (125:H4115, Act 69).",
...
out = {
    ...
    "recent_enactments_watchlist": [
        "126:S831 - SCDOT Modernization Act (Act 177 of 2026, Senate 37-1, House 114-0, conference 112-2/43-0): governor appoints the secretary; commission abolished January 1, 2027; plus the Pothole Mitigation Program (57-5-1800), phased design-build/CMGC (57-5-1710/1720), choice-lane toll rules, P3s (max 60 years), a four-year external audit, and a 33% county 'C'-funds split",
    ...
    "deliberation_prompts": [
        ...
        "Impact fees are named inside the funding-tools proposal, and impact-fee bills died in both directions for eight years while the one enacted impact-fee rule blocked the fees for schools. Is the 1999 Act's maintenance exclusion the real fight?",
