...
CARDS = [
    {"proposal_id": "local-funding-tools",
     ...
     "where_similar_stopped": "Senate Finance, House Ways and Means, Senate Transportation - no hearings. The toll framework itself was later rewritten inside Act 177 of 2026: usage charges only on new-capacity 'choice lanes', never on existing free lanes.",
    ...
    {"proposal_id": "state-master-planning",
     "citizens_proposed": "State-level comprehensive or regional planning in place of fragmented county plans (very high frequency, all 4 events; mixed consensus - the home-rule tension runs through it, though it was a consensus recommendation at the Charleston conversation).",
