...
tab characters. "NH1 Property Taxes Legislative Brief v1.0" is ~1 inch longer
...
DOCX = Path("briefs/new-hampshire/property-taxes/citizen-v2/NH1-Property-Taxes-Lege-Brief.docx")
TEN_TABS = "<w:tab/>" * 10
EIGHT_TABS = "<w:tab/>" * 8
