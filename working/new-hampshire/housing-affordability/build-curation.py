...
# Bills added by the OpenStates bulk-universe collection and the
# certification sweep (2020-2024 complete-universe pass).
E2 = {
    "2020:HB1120": ("Would have studied water-testing requirements for residential rentals.", "T4", "adjacent"),
    "2020:HB1187": ("Animal shelter facilities bill; matched by 'shelter' but not housing.", "CTX", "context"),
    "2020:HB1207": ("Would have required landlords to tell prospective tenants about pesticide use on the property.", "T4", "adjacent"),
    "2020:HB1276": ("Would have changed ex-officio membership on budget committees and planning boards.", "T8", "adjacent"),
    "2020:HB1320": ("Would have required landlords to give renters an insurance notification.", "T4", "adjacent"),
    "2020:HB1324": ("Would have exempted shared-facility rentals from real estate practice act rules.", "T4", "adjacent"),
    "2020:HB1342": ("Would have created a heat-pump installation program for low-income housing.", "T3", "adjacent"),
    "2020:HB1389": ("Animal cruelty penalties; matched by 'shelter' but not housing.", "CTX", "context"),
    "2020:HB143": ("Would have set disqualification rules for local land use board members.", "T8", "adjacent"),
    "2020:HB1439": ("Would have changed notice of zoning determinations and appeals to the zoning board.", "T8", "adjacent"),
    "2020:HB1450": ("Would have revised the powers of the zoning board of adjustment.", "T8", "adjacent"),
    "2020:HB1488": ("Would have barred conditioning employment or student enrollment on approved housing.", "T4", "adjacent"),
    "2020:HB1510": ("Would have let municipalities adopt a property tax exemption for accessory dwelling units.", "T2", "core"),
    "2020:HB1511": ("Would have changed eviction ('actions against tenants') procedures.", "T5", "core"),
    "2020:HB1579": ("Rooms-and-meals tax mechanics for short-term rentals; lodging tax, not housing policy.", "CTX", "context"),
    "2020:HB1588": ("Would have created a mortgage mediation procedure before foreclosure.", "T3", "adjacent"),
    "2020:HB1632": ("Would have created financial investments and incentives for affordable housing development (predecessor of 2021 HB586).", "T3", "core"),
    "2020:HB1709": ("Would have eased building code and zoning rules for home-based child day care providers.", "T1", "adjacent"),
    "2020:HB274": ("Rooms-and-meals tax on internet booking facilitators; lodging tax, not housing.", "CTX", "context"),
    "2020:HB311": ("Would have let the fire marshal exempt recovery houses from fire code rules (predecessor of 2021 HB377).", "T6", "adjacent"),
    "2020:HB653": ("Rooms-and-meals tax payment for short-term rentals; lodging tax, not housing.", "CTX", "context"),
    "2020:SB15": ("Would have appropriated money to the Affordable Housing Fund.", "T3", "core"),
    "2020:SB152": ("Would have regulated third-party inspections under planning board approvals (enacted in 2021 via SB86).", "T8", "adjacent"),
    "2020:SB256": ("Would have required emergency generators in certain senior housing.", "T3", "adjacent"),
    "2020:SB458": ("Would have defined municipal power to regulate vacation and short-term rentals.", "T4", "adjacent"),
    "2020:SB460": ("Would have changed enforcement of zoning violations.", "T8", "adjacent"),
    "2020:SB475": ("Would have let municipalities adopt a property tax credit for densely-built workforce housing.", "T3", "core"),
    "2020:SB482": ("Would have created building code standards for tiny houses (first of three tries before 2026's HB1681).", "T7", "core"),
    "2020:SB487": ("Would have repealed the brand-new Housing Appeals Board and created an affordable-housing commission instead.", "T8", "core"),
    "2020:SB536": ("Would have required an annual report from the Housing Appeals Board.", "T8", "adjacent"),
    "2020:SB562": ("Would have created tax relief for housing in designated residential revitalization zones (enacted in 2021 as SB102).", "T3", "adjacent"),
    "2020:SB605": ("Would have addressed interference with the enjoyment of a dwelling place.", "T5", "adjacent"),
    "2020:SB633": ("Would have regulated recovery housing.", "T6", "adjacent"),
    "2020:SB638": ("Would have created the New Hampshire housing and conservation planning program (enacted in 2021 via HB610).", "T3", "adjacent"),
    "2020:SB69": ("Would have addressed short-term rental regulation.", "T4", "adjacent"),
    "2020:SB710": ("Would have established a homeowners' association act.", "T1", "adjacent"),
    "2020:SB721": None,  # already curated
    "2021:HB132": ("Would have limited acreage required to build certain single-family housing (carried into 2022).", "T1", "core"),
    "2021:HB160": ("Would have required notice of rent increases in certain rentals (first of the notice bills).", "T4", "core"),
    "2021:HB189": ("Would have changed accessory dwelling unit rules.", "T2", "core"),
    "2021:HB249": ("Animal shelter facilities law; matched by 'shelter' but not housing.", "CTX", "context"),
    "2021:HB288": ("Would have eliminated the Housing Appeals Board (second year of repeal attempts).", "T8", "core"),
    "2021:HB341": ("Would have allowed more residential units by right in residential zones (predecessor of 2022 HB1177 and 2023 HB44).", "T1", "core"),
    "2021:HB360": ("Legalized renting shared living facilities (rooming-style housing).", "T4", "core"),
    "2021:HB392": ("Would have changed membership rules for local land use boards.", "T8", "adjacent"),
    "2021:HB395": ("Would have addressed home-share income and shared-facility rentals.", "T4", "adjacent"),
    "2021:HB473": ("Would have required a renter's insurance notification (carried into 2022).", "T4", "adjacent"),
    "2021:HB512": ("Would have expanded emergency housing assistance.", "T6", "core"),
    "2021:HB550": ("Would have addressed nonpayment of rent during the COVID state of emergency.", "T5", "core"),
    "2021:HB588": ("Would have created building code standards for tiny houses (second try).", "T7", "core"),
    "2021:HB616": ("Would have changed court review of planning board decisions.", "T8", "adjacent"),
    "2022:HB1042": ("Health advisory notices for vacation-rental guests; tourism consumer notice, not housing.", "CTX", "context"),
    "2022:HB1068": ("Would have created building code standards for tiny houses (third try).", "T7", "core"),
    "2022:HB1087": ("Would have limited zoning restrictions on single-family housing lots.", "T1", "core"),
    "2022:HB1098": ("Would have capped the parking spaces municipalities can require per dwelling (enacted in part via 2024 HB1400).", "T1", "core"),
    "2022:HB1107": ("Would have studied renting housing to people with pets.", "T4", "adjacent"),
    "2022:HB1133": ("Would have barred terminating a lease during the sale of the property.", "T5", "core"),
    "2022:HB1136": ("Would have required planning boards to list the studies needed for a decision.", "T8", "adjacent"),
    "2022:HB1172": ("Would have required composting and recycling access for public housing residents.", "T4", "adjacent"),
    "2022:HB1177": ("Would have allowed more residential units by right in residential zones (the four-unit predecessor of 2023 HB44).", "T1", "core"),
    "2022:HB1179": ("Would have changed zoning protest petition rules.", "T1", "adjacent"),
    "2022:HB1191": ("Would have eased licensed-trades requirements for work on one- and two-family homes.", "T1", "adjacent"),
    "2022:HB1200": ("Would have required notice of rent increases in residential rentals (second try).", "T4", "core"),
    "2022:HB1216": ("Would have repealed the Housing Appeals Board (third year of attempts).", "T8", "core"),
    "2022:HB1219": ("Would have limited parking requirements for religious-institution housing projects.", "T1", "adjacent"),
    "2022:HB1238": ("Would have tied zoning powers to the supply of workforce housing.", "T1", "core"),
    "2022:HB1254": ("Would have modified the Housing Appeals Board.", "T8", "adjacent"),
    "2022:HB1307": ("Would have modified the Housing Appeals Board's authority and duties.", "T8", "adjacent"),
    "2022:HB132": ("Would have limited acreage requirements for single-family housing (second-year record).", "T1", "core"),
    "2022:HB1374": ("Would have changed membership of local land use boards.", "T8", "adjacent"),
    "2022:HB1389": ("Would have created a superior court land use review docket (idea enacted via HB2 2023, 79:371).", "T8", "core"),
    "2022:HB1407": ("Would have added affordable housing promotion to the land and community heritage program.", "T3", "adjacent"),
    "2022:HB1408": ("Would have required refunds of residential tenancy application fees.", "T4", "core"),
    "2022:HB1430": ("Rooms-and-meals tax on vehicle rentals; not housing.", "CTX", "context"),
    "2022:HB1617": ("Would have addressed community development finance authority housing projects.", "T3", "core"),
    "2021:HB227": ("Would have let landlords end a tenancy at lease expiration (first-year record; carried into 2022).", "T5", "core"),
    "2022:HB227": ("Would have let landlords end a tenancy at the lease's expiration without other cause (filed repeatedly 2021-2024).", "T5", "core"),
    "2022:HB473": ("Would have required a renter's insurance notification (second-year record).", "T4", "adjacent"),
    "2022:HB503": ("Second-year record of 2021 HB503 (Council on Housing Stability; became Chapter 251).", "T6", "core"),
    "2022:SB210": ("Regulated the sale of manufactured housing parks (became law).", "T7", "core"),
    "2022:SB216": ("Would have studied the landlord-tenant mediation program.", "T5", "adjacent"),
    "2022:SB217": ("Would have changed eviction notice rules.", "T5", "core"),
    "2022:SB244": ("Would have addressed non-conforming structures and variances.", "T8", "adjacent"),
    "2022:SB245": ("Would have studied developer-municipality agreements on trash services.", "T1", "adjacent"),
    "2022:SB249": ("Would have barred zoning ordinances that prohibit short-term rentals.", "T4", "adjacent"),
    "2022:SB324": ("Condominium and homeowners' association dispute resolution; governance, kept for audit.", "CTX", "context"),
    "2022:SB329": ("Would have created a commission on barriers to housing development plus an invest-in-housing framework.", "T9", "core"),
    "2022:SB338": ("Would have enabled a municipal occupancy fee on short-term room rentals.", "T4", "adjacent"),
    "2022:SB359": ("Would have required an inventory of all state real estate.", "T3", "adjacent"),
    "2023:HB117": ("Would have let landlords end a tenancy at lease expiration (retry of HB227).", "T5", "core"),
    "2023:HB184": ("Would have changed public notice for zoning board hearings.", "T8", "adjacent"),
    "2023:HB235": ("Created a study committee on the landlord-tenant mediation program.", "T5", "adjacent"),
    "2023:HB236": ("Would have addressed condominium conversions under water and waste disposal laws.", "T1", "adjacent"),
    "2023:HB261": ("Would have let tenants end leases in domestic violence situations (carried over; enacted as 2024 HB261).", "T5", "core"),
    "2023:HB273": ("Would have required composting and recycling access in public housing (retry).", "T4", "adjacent"),
    "2023:HB283": ("Would have limited rental application fees (carried over; enacted as 2024 HB283).", "T4", "core"),
    "2023:HB310": ("Would have required developers to certify water capacity before building.", "T1", "adjacent"),
    "2023:HB340": ("Would have changed rules for transfers of residential property.", "T4", "adjacent"),
    "2023:HB347": ("Land use review docket bill (carried over into 2024).", "T8", "core"),
    "2023:HB355": ("Would have studied data sharing between state and federal public housing agencies.", "T9", "adjacent"),
    "2023:HB379": ("Would have required telling tenants about legal counsel during evictions (carried over).", "T5", "core"),
    "2023:HB416": ("Would have changed membership on certain local land use boards.", "T8", "adjacent"),
    "2023:HB422": ("Would have created a public county registry of rents (predecessor of 2025 HB558).", "T4", "core"),
    "2023:HB423": ("Would have allowed accessory dwelling units by right (predecessor of 2024 HB1291).", "T2", "core"),
    "2023:HB636": ("Would have required education for zoning board members (the training thread).", "T8", "core"),
    "2023:SB101": ("Manufactured housing park sales penalties (carried over into 2024).", "T7", "core"),
    "2023:SB202": ("Would have created a homeownership innovations fund at New Hampshire Housing.", "T3", "core"),
    "2023:SB224": ("Housing opportunity zones and inclusionary zoning (carried over into 2024).", "T3", "core"),
    "2023:SB262": ("Would have let municipalities collect an occupancy fee from room-rental operators (retry of 2020 HB1160).", "T4", "adjacent"),
    "2023:SB33": ("Manufactured housing park lot-rent fee differential (carried over into 2024).", "T7", "core"),
    "2023:SB47": ("Would have created a commission on barriers to increased residential density.", "T9", "core"),
    "2023:SB64": ("Study of resident-owned manufactured housing park disputes (carried over into 2024).", "T7", "adjacent"),
    "2023:SB78": ("Changed subdivision regulations on completing improvements (became law).", "T1", "adjacent"),
    "2023:SR10": ("Senate resolution urging Congress to fund housing supply expansion (adopted).", "T9", "adjacent"),
    "2024:CACR16": ("Constitutional amendment on local construction project variances and waivers.", "T1", "adjacent"),
    "2024:HB1053": ("Would have allowed residential units in commercial zones (predecessor of 2025 HB631).", "T1", "core"),
    "2024:HB1086": ("Would have changed public notice of zoning board hearings (retry).", "T8", "adjacent"),
    "2024:HB1101": ("Would have studied a state loan program for low-to-moderate income homebuyers.", "T3", "core"),
    "2024:HB1115": ("Would have let landlords end a tenancy at lease expiration (third filing; interim study).", "T5", "core"),
    "2024:HB1140": ("Eased requirements for homeowner septic system installations (became law).", "T1", "adjacent"),
    "2024:HB1168": ("Created a study committee on the housing crisis's impact on people with disabilities.", "T9", "adjacent"),
    "2024:HB1203": ("Charitable gaming facility rent rules; gaming regulation, not housing.", "CTX", "context"),
    "2024:HB1215": ("Would have changed development approvals, appeals, and vesting rules; conference report failed.", "T1", "core"),
    "2024:HB1281": ("Would have limited zoning restrictions on residential rental property.", "T1", "core"),
    "2024:HB1284": ("Would have defined planning boards' quasi-judicial authority.", "T8", "adjacent"),
    "2024:HB1358": ("Beer/wine tenant manufacturers; alcohol regulation, not housing.", "CTX", "context"),
    "2024:HB1362": ("Would have let municipalities stabilize rent increases in rental housing.", "T4", "core"),
    "2024:HB1368": ("Would have barred eviction for nonpayment of corporate-raised rent.", "T5", "core"),
    "2024:HB1371": ("Master plan waste-reduction section; solid waste, not housing.", "CTX", "context"),
    "2024:HB1456": ("Changed appointment and removal of Board of Tax and Land Appeals and Housing Appeals Board members (became law).", "T8", "adjacent"),
    "2024:HB1483": ("Would have allowed subdivision regulations concerning water supply.", "T1", "adjacent"),
    "2024:HB1498": ("Would have created a state short-term rental registry.", "T4", "adjacent"),
    "2024:HB1521": ("Would have regulated recovery houses; died in conference.", "T6", "adjacent"),
    "2024:HB1544": ("Would have shielded municipalities adopting homelessness policies (predecessor of 2025 HB490).", "T6", "adjacent"),
    "2024:HB1602": ("Would have changed the Housing Appeals Board's authority (sent to interim study).", "T8", "adjacent"),
    "2024:HB1635": ("Would have defined 'short-term rental'.", "T4", "adjacent"),
    "2024:HB1651": ("Would have combined the Board of Tax and Land Appeals and the Housing Appeals Board (the idea HB2 2025 later enacted).", "T8", "core"),
    "2024:HB1672": ("Would have addressed tenants in Section 8 public housing.", "T5", "core"),
    "2024:HB261": ("Gave tenants lease-termination rights in domestic violence situations (became law).", "T5", "core"),
    "2024:HB283": ("Regulated rental application fees charged to prospective tenants (became law).", "T4", "core"),
    "2024:HB347": ("Would have created a superior court land use review docket (standalone retry; the budget-trailer version was already law).", "T8", "core"),
    "2024:HB379": ("Would have required telling tenants about legal counsel during evictions (interim study).", "T5", "core"),
    "2024:SB101": ("Would have set penalties for manufactured housing park sales violations.", "T7", "core"),
    "2024:SB224": ("Would have expanded housing opportunity zones and enabled inclusionary zoning (interim study).", "T3", "core"),
    "2024:SB306": ("Moved manufactured housing rulemaking authority (became law).", "T7", "adjacent"),
    "2024:SB33": ("Would have addressed lot-rent fee differentials in manufactured housing parks.", "T7", "core"),
    "2024:SB364": ("Would have created a historic housing preservation tax credit (interim study).", "T3", "core"),
    "2024:SB384": ("Would have created a municipal loan and grant program for rental housing.", "T3", "core"),
    "2024:SB408": ("Would have studied the housing crisis's effects on the disability community.", "T9", "adjacent"),
    "2024:SB410": ("Would have funded community and transitional housing through mental health centers (predecessor of 2025 SB114).", "T6", "core"),
    "2024:SB413": ("PFAS civil actions bill carrying a tenancy-termination rider; died in conference.", "T5", "adjacent"),
    "2024:SB434": ("Would have created an extended-stay housing program with a tax exemption.", "T6", "adjacent"),
    "2024:SB503": ("Fish and game licensing omnibus; matched by search terms but not housing.", "CTX", "context"),
    "2024:SB518": ("Would have created incentives for landlords to accept housing choice vouchers (interim study).", "T5", "core"),
    "2024:SB519": ("Would have limited renovation evictions (retry of 2023 HB401; died at Senate deadline).", "T5", "core"),
    "2024:SB527": ("Addressed student housing (became law).", "T3", "adjacent"),
    "2024:SB64": ("Would have studied resident-owned manufactured housing park disputes (interim study).", "T7", "adjacent"),
}
E2 = {k: v for k, v in E2.items() if v is not None}
E.update(E2)
