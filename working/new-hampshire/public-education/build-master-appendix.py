...
"""Build the Master Appendix: all appendices A-I as one document.
  ...
  NH1-Public-Education-Master-Appendix.docx  (title page + A-I, branded
                                            pandoc reference conversion)
  NH1-Public-Education-Master-Appendix.pdf   (the Phase 2 print styling with
...
DIR = Path("briefs/new-hampshire/public-education/citizen-v2/appendices")

TITLE_MD = """# NH1 Public Education — Master Appendix

**Public Education in New Hampshire — the complete appendix record**

The Forum · NH1 Public Education Legislative Brief v1.0 · August 2026

This document collects Appendices A–I behind the NH1 Public Education
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        export_docx.convert([title] + md_files,
                            DIR / "NH1-Public-Education-Master-Appendix.docx",
                            "NH1 Public Education Master Appendix")
    subprocess.run([
        "google-chrome", "--headless=new", "--no-sandbox",
        "--user-data-dir=/tmp/chrome-master",
        f"--print-to-pdf={DIR / 'NH1-Public-Education-Master-Appendix.pdf'}",
        "--no-pdf-header-footer",
        str(DIR / "appendices-print.html"),
    ], check=True)
    print(f"Wrote {DIR / 'NH1-Public-Education-Master-Appendix.pdf'}")
