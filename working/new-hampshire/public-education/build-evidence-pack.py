#!/usr/bin/env python3
"""Assemble the NH public-education evidence pack (Evidence Curator v2.2, NH shapes; public-education run).
...
Run from repo root:
  python3 working/new-hampshire/public-education/build-evidence-pack.py
"""
...
def main() -> None:
    ...
    hb2_tieins = [
        {"bill_key": "2021:HB20", "hb2": "91:431",
         "note": "The standalone EFA bills (HB20, SB130) stalled in 2021; the education freedom account program was enacted inside the 2021 trailer as section 91:431."},
        {"bill_key": "2021:HB544", "hb2": "91:298",
         "note": "The standalone divisive concepts bill was tabled; the teaching ban passed inside the 2021 trailer (91:297-298) instead."},
        {"bill_key": "2025:HB781", "hb2": "141:455",
         "note": "Both standalone cell-phone bills failed (HB781 vetoed; SB206 died between the chambers) - the statewide phone-policy mandate passed inside the 2025 trailer as 141:455."},
        {"bill_key": "2025:HB115", "hb2": "141:16",
         "note": "The universal-EFA bill HB115 was vetoed, but SB295 (Chapter 75) removed the income cap the same year and the 2025 trailer carried the contingency mechanics (141:16-17)."},
        {"bill_key": "2026:HB431", "hb2": "141:275",
         "note": "The standalone special-education cost commission bill died - SB57 (2025) created the commission, and the 2025 trailer restructured special-education aid and ordered the independent program audit (141:275-278)."},
        {"bill_key": "2026:HB1456", "hb2": "141:389",
         "note": "The 2025 trailer declared the legislature's authority over public education (141:389); HB1456's repeal of that declaration died in committee, and HCR11's stronger anti-Claremont declaration died on the table."},
    ]
    ...
    # ---- human skim ----
    md = ["# Evidence pack — Public Education in New Hampshire", ""]
