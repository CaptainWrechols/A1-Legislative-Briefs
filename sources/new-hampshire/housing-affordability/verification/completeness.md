...
Bills: 149  |  PASS 17 / WARN 2 / FAIL 0
...
- **PASS** `sessions_covered` — bills/year={2020: 6, 2021: 8, 2022: 4, 2023: 9, 2024: 8, 2025: 36, 2026: 78}; missing_unexplained=[]
- **PASS** `bill_fields_complete` — 0 incomplete of 149
- **PASS** `votes_row_per_bill` — missing_vote_rows=0 examples=[]
- **PASS** `vote_counts_are_integers` — all yea/nay integers or null
- **WARN** `search_term_coverage` — hits={'housing': 61, 'affordable housing': 11, 'workforce housing': 4, 'attainable housing': 0, 'dwelling': 17, 'apartment': 0, 'multi-family': 4, 'multifamily': 2, 'residential development': 2, ' rent': 19, 'rental housing': 1, 'landlord': 9, 'tenant': 13, 'eviction': 5, 'security deposit': 1, 'rent control': 0, 'missing middle': 0, 'zoning': 29, 'land use': 10, 'accessory dwelling': 10, 'ADUs': 1, 'lot size': 0, 'density': 3, 'infill': 0, 'housing production': 0, 'inclusionary': 0, 'impact fee': 2, 'manufactured housing': 7, 'mobile home': 1, 'modular': 0, 'tiny home': 0, 'starter home': 0, 'homebuyer': 0, 'home buyer': 1, 'down payment': 0, 'mortgage': 2, 'housing trust': 0, 'housing appeals': 0, 'homelessness': 2, 'homeless': 5, 'shelter': 3}; empty_search_terms=['attainable housing', 'apartment', 'rent control', 'missing middle', 'lot size', 'infill', 'housing production', 'inclusionary', 'modular', 'tiny home', 'starter home', 'homebuyer', 'down payment', 'housing trust', 'housing appeals']
