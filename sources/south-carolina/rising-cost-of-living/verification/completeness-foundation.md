# SC collection completeness — rising-cost-of-living (foundation mode)
...
- **PASS** `proviso_sections_present` — working/south-carolina/rising-cost-of-living/proviso-sections.json: proviso_count=1354 (min 100); cycle=2025-2026 version=ta
- **PASS** `proviso_relevant_present` — working/south-carolina/rising-cost-of-living/proviso-relevant.json: relevant=544
