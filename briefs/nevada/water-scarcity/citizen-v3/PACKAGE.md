...
python collectors/export_brief_html.py --brief-dir briefs/nevada/water-scarcity/citizen-v3

# Glossary (same shell; --file selects the document)
python collectors/export_brief_html.py --brief-dir briefs/nevada/water-scarcity/citizen-v3 --file glossary
python collectors/export_docx_brief.py --brief-dir briefs/nevada/water-scarcity/citizen-v3 --file glossary
...
python collectors/export_docx.py --brief-dir briefs/nevada/water-scarcity/citizen-v3
```
