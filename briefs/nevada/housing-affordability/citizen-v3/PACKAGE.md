# Package — Housing Affordability in Nevada (citizen-v3.0)
...
python collectors/export_brief_html.py --brief-dir briefs/nevada/housing-affordability/citizen-v3

# Glossary (same shell; --file selects the document)
python collectors/export_brief_html.py --brief-dir briefs/nevada/housing-affordability/citizen-v3 --file glossary
python collectors/export_docx_brief.py --brief-dir briefs/nevada/housing-affordability/citizen-v3 --file glossary

# Word (front brief via python-docx direct formatting; appendices via pandoc)
ISSUE_CONFIG=config/issues/nevada-housing.yaml \
python collectors/export_docx.py --brief-dir briefs/nevada/housing-affordability/citizen-v3
```
