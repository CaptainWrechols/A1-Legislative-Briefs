...
Known collection gaps recorded during the refresh: 432 items (see `sources/nevada/housing-affordability/processed/data-gaps.json`). OpenStates was unavailable for this refresh; all history, votes, and party labels come from the official NELIS system and legislator rosters, with committee votes read from official minutes PDFs.
