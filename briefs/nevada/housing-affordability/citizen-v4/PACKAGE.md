# Package — Housing Affordability in Nevada (citizen-v4.0)
...
- **Real Word footer** ("NV1 Housing Legislative Brief v4.0" plus an automatic page number) — an
...
```bash
python collectors/export_docx_brief.py --brief-dir briefs/nevada/housing-affordability/citizen-v4 \
  --no-masthead --footer "NV1 Housing Legislative Brief v4.0"
python collectors/export_brief_html.py --brief-dir briefs/nevada/housing-affordability/citizen-v4 \
  --no-masthead --footer "NV1 Housing Legislative Brief v4.0"
```
...
```bash
python collectors/export_docx_brief.py --brief-dir briefs/nevada/housing-affordability/citizen-v4 \
  --file proposal-spotlights --layout prose --no-masthead --footer "NV1 Housing Policy Spotlights v4.0"
python collectors/export_brief_html.py --brief-dir briefs/nevada/housing-affordability/citizen-v4 \
  --file proposal-spotlights --layout prose --no-masthead --footer "NV1 Housing Policy Spotlights v4.0"
```
