# Package — Housing Affordability in Nevada (citizen-v2.0)
...
python collectors/export_brief_html.py --brief-dir briefs/nevada/housing-affordability/citizen-v2

# Word (front brief via python-docx direct formatting; appendices via pandoc)
ISSUE_CONFIG=config/issues/nevada-housing.yaml \
python collectors/export_docx.py --brief-dir briefs/nevada/housing-affordability/citizen-v2
```
