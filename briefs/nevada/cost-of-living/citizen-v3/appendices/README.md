# Appendices — The Rising Cost of Living in Nevada: Health Care

Long-form detail behind the 2-page citizen front brief (citizen-v1.0).
Built from the July 2026 collection: 772 bills found, 409 policy bills.

| File | Contents |
|---|---|
| `A-bills-overview.md` | Every bill: plain topic, theme, result, where it ended, sponsors (policy + context sets) |
| `B-theme-scorecards.md` | Nine themes with baskets, stop patterns, and full bill tables |
