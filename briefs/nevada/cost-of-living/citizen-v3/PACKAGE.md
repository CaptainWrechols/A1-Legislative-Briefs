# Package — The Rising Cost of Living in Nevada: Health Care (citizen-v2.0)
...
python collectors/export_brief_html.py --brief-dir briefs/nevada/cost-of-living/citizen-v2
...
python collectors/export_docx.py --brief-dir briefs/nevada/cost-of-living/citizen-v2
```
