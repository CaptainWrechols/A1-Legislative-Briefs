# Package — The Rising Cost of Living in Nevada: Health Care (citizen-v4.0)
...
- **Real Word footer** ("NV1 Healthcare Legislative Brief v4.0" plus an automatic page number) — an
