...
The full machine-readable record — bills, votes, ballots, dockets, HB2 sections, and per-claim evidence — lives in the repository under `sources/new-hampshire/property-taxes/` and `working/new-hampshire/property-taxes/`.
